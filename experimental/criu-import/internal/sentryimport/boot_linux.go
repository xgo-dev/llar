...
// newKernel initializes a conversion kernel or an empty restore kernel.
// Kernel.Release requires a fully initialized kernel and host mount.
func newKernel(inspect inspector, restoring bool, backend string) (*kernel.Kernel, error) {
	cpuid.Initialize()
	seccheck.Initialize()
	...
	p = &observedPlatform{Platform: p, inspect: inspect}
